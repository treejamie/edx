...
def test_calculateHandlen():
    #
    assert 9 == calculateHandlen({'q': 1, 'k': 1, 'x': 1, 'n': 1, 'a': 2, 'y': 1, 'u': 1, 'r': 1})
    assert 0 == calculateHandlen({'y': 0, 'z': 0, 'x': 0})
    assert 12 == calculateHandlen({'q': 1, 'n': 2, 'a': 1, 't': 2, 'r': 1, 'k': 1, 'f': 1, 'i': 1, 'x': 1, 'c': 1}) == 12
    print('SUCCESS')
